                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            <tr v-if="founders.length" v-for="(founder, index) in founders" :key="index">
                                                ...
                                                <td>@{{ founder.share }}</td>
                                                <td>@{{ founder.paid }}&euro;</td>
                                                <td>
                                                    <button class="btn btn-icon btn-light btn-hover-primary btn-sm" @click.prevent>
                                                ...
                                                <td>
                                                    <button class="btn btn-icon btn-light btn-hover-primary btn-sm" @click.prevent="removeFounder(founder)">
                                                        <span class="svg-icon svg-icon-md svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24" />
