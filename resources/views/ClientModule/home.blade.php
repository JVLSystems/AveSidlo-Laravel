                                            ...
                                            <div class="flex-grow-1 card-spacer-x">
                                                    ...
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="{{ asset('/adm/assets/media/svg/misc/006-plurk.svg') }}" alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="{{ asset('/adm/assets/media/svg/misc/015-telegram.svg') }}" alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="{{ asset('/adm/assets/media/svg/misc/003-puzzle.svg') }}" alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                ...
                                <div class="col-xl-8">
                                    <div class="row">
                                        <div class="col-xl-3">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url({{ asset('/adm/assets/media/bg/bg-9.jpg') }}">
                                                <!--begin::Body-->
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url({{ asset('/adm/assets/media/svg/patterns/taieri.svg') }})">
                                                <!--begin::Body-->
                                                    ...
                                                    <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                                        <div class="card-body">
                                                                    <span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
                                                                        <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Layout/Layout-4-blocks.svg') }}-->
                                                    ...
                                                    <div class="card card-custom gutter-b" style="height: 150px">
                                                        <div class="card-body">
                                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                                        <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Communication/Group.svg') }}-->
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url({{ asset('/adm/assets/media/stock-600x600/img-16.jpg') }}">
                                                <!--begin::Body-->
                                                <div class="card-body d-flex flex-column align-items-start justify-content-start">
                                                    ...
                                                    <a href='#' class="btn btn-link btn-link-warning font-weight-bold">Create Report
                                                        <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Navigation/Arrow-right.svg') }}-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <polygon points="0 0 24 0 24 24 0 24" />
                                            ...
                                            <div class="card-toolbar">
                                                <a href="#" class="btn btn-success font-weight-bolder font-size-sm">
                                                        <span class="svg-icon svg-icon-md svg-icon-white">
                                                            <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Communication/Add-user.svg') }}-->
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <polygon points="0 0 24 0 24 24 0 24" />
                                                ...
                                                <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                                        ...
                                                        <td class="pr-0">
                                                            <div class="symbol symbol-50 symbol-light mt-1">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ asset('/adm/assets/media/svg/avatars/001-boy.svg') }}" class="h-75 align-self-end" alt="" />
                                                                            </span>
                                                            </div>
                                                        </td>
                                                        <td class="pl-0">
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/General/Settings-1.svg') }}-->
                                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                        <rect x="0" y="0" width="24" height="24" />
                                                            ...
                                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Communication/Write.svg') }}-->
                                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                        <rect x="0" y="0" width="24" height="24" />
                                                            ...
                                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/General/Trash.svg') }}-->
                                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                        <rect x="0" y="0" width="24" height="24" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0">
                                                            <div class="symbol symbol-50 symbol-light mt-1">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ asset('/adm/assets/media/svg/avatars/018-girl-9.svg') }}') }}" class="h-75 align-self-end" alt="" />
                                                                            </span>
                                                            </div>
                                                        </td>
                                                        <td class="pl-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0">
                                                            <div class="symbol symbol-50 symbol-lightv mt-1">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ asset('/adm/assets/media/svg/avatars/047-girl-25.svg') }}" class="h-75 align-self-end" alt="" />
                                                                            </span>
                                                            </div>
                                                        </td>
                                                        <td class="pl-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0">
                                                            <div class="symbol symbol-50 symbol-light mt-1">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ asset('/adm/assets/media/svg/avatars/014-girl-7.svg') }}" class="h-75 align-self-end" alt="" />
                                                                            </span>
                                                            </div>
                                                        </td>
                                                        <td class="pl-0">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center pr-2 mb-6">
                                                    ...
                                                    <div class="symbol symbol-50">
                                                                <span class="symbol-label bg-light-light">
                                                                    <img src="{{ asset('/adm/assets/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center" alt="" />
                                                                </span>
                                                    </div>
                                                </div>
                                                <!--end::Info-->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('/adm/assets/media/svg/avatars/028-girl-16.svg') }}" class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                                <!--begin::Pic-->
                                                <a href="#" class="symbol symbol-45 symbol-light">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('/adm/assets/media/svg/avatars/024-boy-9.svg') }}" class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                            </div>
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            <div class="flex-grow-1 pb-5">
                                                ...
                                                <div class="d-flex align-items-center pr-2 mb-6">
                                                    ...
                                                    <div class="symbol symbol-50">
                                                                <span class="symbol-label bg-light-light">
                                                                    <img src="{{ asset('/adm/assets/media/svg/misc/015-telegram.svg') }}" class="h-50 align-self-center" alt="" />
                                                                </span>
                                                    </div>
                                                </div>
                                                <!--end::Info-->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('/adm/assets/media/svg/avatars/005-girl-2.svg') }}" class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                            </div>
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            <div class="flex-grow-1 pb-5">
                                                ...
                                                <div class="d-flex align-items-center pr-2 mb-6">
                                                    ...
                                                    <div class="symbol symbol-50">
                                                                <span class="symbol-label bg-light-light">
                                                                    <img src="{{ asset('/adm/assets/media/svg/misc/003-puzzle.svg') }}" class="h-50 align-self-center" alt="" />
                                                                </span>
                                                    </div>
                                                </div>
                                                <!--end::Info-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                                                ...
                                                <span class="svg-icon svg-icon-warning mr-5">
                                                            <span class="svg-icon svg-icon-lg">
                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Home/Library.svg') }}-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
                                            ...
                                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
                                                ...
                                                <span class="svg-icon svg-icon-danger mr-5">
                                                            <span class="svg-icon svg-icon-lg">
                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/Communication/Group-chat.svg') }}-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
                                            ...
                                            <div class="d-flex align-items-center bg-light-info rounded p-5">
                                                ...
                                                <span class="svg-icon svg-icon-info mr-5">
                                                            <span class="svg-icon svg-icon-lg">
                                                                <!--begin::Svg Icon | path:{{ asset('/adm/assets/media/svg/icons/General/Attachment2.svg') }}-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
